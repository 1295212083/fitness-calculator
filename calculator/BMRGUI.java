...
public class BMRGUI extends JFrame {
	...
	public BMRGUI() {
		...
		lblResultTitle.setFont(new Font("Tahoma", Font.PLAIN, 12));
		lblResultTitle.setBackground(new Color(255, 255, 255));
		lblResultTitle.setBounds(282, 101, 75, 14);
		contentPane.add(lblResultTitle);
		
		lblResult = new JLabel("");
		lblResult.setBounds(248, 122, 124, 30);
